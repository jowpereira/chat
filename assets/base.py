...
:root {
    ...
    --chat-user: linear-gradient(135deg, rgba(255, 229, 229, 0.7) 0%, rgba(255, 250, 250, 0.7) 100%);
    --chat-assistant: linear-gradient(135deg, rgba(248, 240, 255, 0.7) 0%, rgba(252, 233, 236, 0.7) 100%);
    --text-primary: #333333;
